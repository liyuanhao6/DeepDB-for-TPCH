...
from schemas.tpch.schema import gen_job_light_tpch_schema
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sdql', default=False)
    ...
    if args.dataset == 'tpch-light':
        schema = gen_job_light_tpch_schema(table_csv_path)
    ...
    if args.evaluate_cardinalities:
        ...
        evaluate_cardinalities(args.ensemble_location, args.database_name, args.query_file_location, args.target_path,
                            ...
                            merge_indicator_exp=args.merge_indicator_exp,
                            exploit_overlapping=args.exploit_overlapping, max_variants=args.max_variants,
                            true_cardinalities_path=args.ground_truth_file_location, min_sample_ratio=0, is_sdql=args.sdql)
